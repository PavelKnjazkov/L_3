<?php
$name = "Павел";
$profession = "Бездельник";
$cityCountry = "Россия, Санкт-Петербург";
$email = "na_emaile@pisem.net";
$phone = "+79119110203";
$phone1 = "+79119110405";
$skills = [
  [
    'name' => 'Лежать на диване',
    'percent' => 30,
  ],
  [
    'name' => 'Пялиться в телек',
    'percent' => 70,
  ],
  [
    'name' => 'Играть в PS',
...
$workExperience = [
  [
    'jobTitle' => 'Стадия "вечный студент"',
    'dateStart' => 'Август 2022',
    'dateEnd' => 'До сих пор.',
    'jobDescription' => 'Пошел учиться на программиста в GB.',
  ],
  [
    'jobTitle' => 'Мыслитель',
    'dateStart' => 'Январь 2015',
    'dateEnd' => 'Август 2022',
    'jobDescription' => 'Осмысление и поиск смысла жизни.',
  ],
  [
    'jobTitle' => 'Раб на галерах',
    'dateStart' => 'Лето 2011',
    'dateEnd' => 'Январь 2015',
    'jobDescription' => 'Бла бла бла',
  ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          <div class="w3-display-container">
            <img src="https://www.internetanneleri.com/wp-content/uploads/2017/10/baba-bebek-1234532354.png" style="width:100%" alt="Avatar">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $cityCountry; ?></p>
            <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $email; ?></p>
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $phone; ?></p>
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $phone1; ?></p>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($workExperience); $i++) : ?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?php echo $workExperience[$i]['jobTitle']; ?></b></h5>
              ...
              <p><?php echo $workExperience[$i]['jobDescription']; ?></p>
              <hr>
            </div>
          <?php endfor; ?>
        </div>
